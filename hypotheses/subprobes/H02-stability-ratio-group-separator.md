...
- 2026-04-18 — tick `20260418_192415` — infra-blocked: Blocked on infra: `sweep_digest.py` emits `stability_ratio` only as a per-group scalar. To compare group separation *on the ratio*, the digest needs to materialize the ratio as a time series per group and pass those DataFrames to `group_separation`.
- 2026-04-18 — tick `20260418_192620` — infra-blocked: Blocked on infra: `sweep_digest.py` emits `stability_ratio` only as a per-group scalar. To compare group separation *on the ratio*, the digest needs to materialize the ratio as a time series per group and pass those DataFrames to `group_separation`.
- 2026-04-18 — tick `20260418_201921` — infra-blocked: Blocked on infra: `sweep_digest.py` emits `stability_ratio` only as a per-group scalar. To compare group separation *on the ratio*, the digest needs to materialize the ratio as a time series per group and pass those DataFrames to `group_separation`.
- 2026-04-18 — tick `20260418_205846` — infra-blocked: Blocked on infra: `sweep_digest.py` emits `stability_ratio` only as a per-group scalar. To compare group separation *on the ratio*, the digest needs to materialize the ratio as a time series per group and pass those DataFrames to `group_separation`.
